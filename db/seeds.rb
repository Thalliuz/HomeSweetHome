...
Issue.create(name: 'Anthony Haler', address: 'something street', number: '1212', detail: 'My refrigerator stopped working.', status: 'pending', user_id: '1', owner_id: '1')
Issue.create(name: 'Michael Haler', address: 'Pink Lion Lane', number: '10', detail: 'Mold in the walls please take a look.', status: 'pending', user_id: '2', owner_id: '2')
