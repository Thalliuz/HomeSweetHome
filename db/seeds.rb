...
Owner.create(firstname: 'Tiffany',lastname: 'Peon', username: 'GuineaGirl', address: '12 Queens Boulevard, Elmhurst, NY', phonenumber: '1111111111', password: '123')
...
Issue.create(name: 'Thomas Mercer', address: '14 Thomas St, Toms River, NJ', status: 'pending', url: 'http://bit.ly/2zih5zu', detail: 'The toliet will not stop running. I left to go to the store and came back its still running and i have water everywhere. I need this fixed asap i cannot have all of this water everywhere I am running out of paper towels.', user_id: '3', owner_id: '1')
